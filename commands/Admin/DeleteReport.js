...
module.exports = {
  name: "deletereport",
  alias: ["removereport","delreport","removerreportes","eliminarreportes"],
...
async execute (client, message, args){
    ...
    db.delete(`reportschannel_${message.guild.id}`)
    message.channel.send(`El canal de reportes fue borrado de la base de datos.`)
