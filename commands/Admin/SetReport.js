...
module.exports = {
  name: "setreport",
  alias: ["setreportes","colocarreportes"],
...
async execute (client, message, args){
    ...
    if(!lasmenciones) {
      return message.channel.send(`**${message.author.username}**, por favor, menciona o pone la ID del canal para los reportes.`)
    } 
    ...
    db.set(`reportschannel_${message.guild.id}`, lasmenciones.id)
    message.channel.send(`El nuevo canal de reportes es ${lasmenciones}.`)
  }
}